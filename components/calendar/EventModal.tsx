      ...
      <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-start gap-3 bg-slate-100 dark:bg-slate-800 p-3 rounded-2xl">
            ...
            <textarea className="bg-transparent flex-1 outline-none text-sm h-16 resize-none" placeholder="메모" value={description} onChange={(e) => setDescription(e.target.value)} />
          </div>

          {/* 끝나는 시간과 반복 일정을 한 줄에 반씩 차지하는 별도 영역으로 분리 */}
          <div className={showTime ? 'grid grid-cols-2 gap-2' : ''}>
            ...
            <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded-2xl min-w-0">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <select
                  className="flex-1 min-w-0 bg-white dark:bg-slate-900 text-sm rounded-lg px-1.5 py-1.5 outline-none border border-slate-300 dark:border-slate-700"
                ...
                {recurrenceType !== 'none' && (
                  <>
                    <input
                      ...
                      className="w-12 shrink-0 bg-white dark:bg-slate-900 text-sm text-right rounded-lg px-1 py-1.5 outline-none border border-slate-300 dark:border-slate-700"
                    />

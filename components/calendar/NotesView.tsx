      ...
      <div className="relative shrink-0">
        ...
        {folderPickerOpen && (
          <>
            ...
            <div className="absolute top-14 left-0 z-50 w-64 max-h-80 overflow-y-auto rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-2xl p-2 space-y-0.5">

...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '화면이 좁을 때는 상단의 넓게보기 아이콘을 누르면 폰 넓은화면 기본 폭으로 볼 수 있어요. 월별보기에서는 칸 높이도 함께 늘어나 그날의 일정이 잘리지 않고 다 보여요(이때는 표 안에서만 좌우로 움직이고 탭은 안 넘어가요). 화면이 이미 넓은 태블릿·PC에서는 같은 자리에 "펼치기" 아이콘이 대신 보이는데, 좌우로 늘릴 필요는 없어서 칸 높이만 늘려줘요.',
    ],
  },
  {
    title: '✅ 할일',

...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '할일에 처음 날짜를 설정하면 "일정으로도 저장할까요?"라고 물어봐요. "네"를 선택해야 캘린더에도 하루종일 일정으로 함께 나타나고, "다시 묻지 않기"로 다음부터 안 물어보게 할 수 있어요.',
      '할일 목록 상단에 실제로 만들어진 폴더 색깔원이 보여요. 누르면 그 폴더 할일만 볼 수 있어요.',
  ...
  },
  {
    ...
    items: [
      ...
      '메모에 폴더를 만들어서 분류할 수 있어요. 폴더를 만들거나 이름을 바꿀 때 색깔원(7가지 중 선택)도 함께 지정할 수 있고, 목록 상단에는 실제로 만들어진 폴더 색깔원만 보여줘서 눌러 바로 필터링할 수 있어요.',
